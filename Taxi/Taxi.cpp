...
// Taxi.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CTaxiApp, CWinApp)
...
// Единственный объект CTaxiApp

CTaxiApp theApp;


// Инициализация CTaxiApp

BOOL CTaxiApp::InitInstance()
{
